...
const RecipeDetail = () => {
  ...
  return (
    <>
      <SEO 
        title={recipe.title}
        description={`Learn how to make ${recipe.title}. A delicious ${recipe.area || ''} ${recipe.category || ''} dish. Full recipe with ingredients and instructions.`}
        image={recipe.image}
        keywords={`${recipe.title}, ${recipe.category}, ${recipe.area}, recipe`}
      />
